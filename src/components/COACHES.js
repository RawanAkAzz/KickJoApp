              ...
              >
                ...
                >
                  <ImageBackground
                    ...
                    source={require("../assests/images/C1.png")}
                    style={{
...
{Platform.OS==='android' ?
                      ...
                      <View
                        style={{
                          flexDirection: "column",
                          justifyContent: "space-between",
                          marginBottom:Dimensions.get('window').height/2.70
                        }}
                      >
                        <LinearGradient
                          colors={['rgb(7,37,78)', 'rgb(18,62,69)', 'rgb(55,137,48)']}
              ...
              >
                ...
                >
                  <ImageBackground
                    ...
                    source={require("../assests/images/c2.png")}
                    style={{
                      height: Dimensions.get('window').height / 3,
                      width: "100%",
                      marginBottom: 10,
              ...
              >
                ...
                >
                  <ImageBackground
                    ...
                    source={require("../assests/images/c3.png")}
                    style={{
                      height: Dimensions.get('window').height / 3,
                      width: "100%",
                      marginBottom: 10,
...
export default connect(mapStateToProps, { signOut, isLoggIn, ...homeAction })(COACHES);